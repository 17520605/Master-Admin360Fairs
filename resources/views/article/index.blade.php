...
@section('content')
    <div class="content">
        <div class="container-fluid">
            ...
            <a type="button" href="{{ route('management.get.article.create') }}"
                            ...
                            <tbody>
                                @if(@isset($articles) > 0)
                                    ...
                                    <tr data-article-id='{{$article->id}}'>
                                        ...
                                        <td> 
                                            <a class="btn waves-effect waves-light btn-success" href="{{route('management.get.article.edit', $article->id)}}" ><i class="mdi mdi-pencil-outline"></i></a>
...
<script>
    ...
    function confirmDelete(target){
        ...
        $.ajax({
            ...
            type: "delete",
            url: "{{env('APP_URL')}}/management/article/" + id,
            data: "data",
            dataType: "json",
    ...
    function toggleVisiable(target){
            ...
            $.ajax({
                ...
                type: "post",
                url: "{{env('APP_URL')}}/management/article/" + id + "/toggle-visiable",
                dataType: "json",
                success: function (res) {
                    if(res.success === true){
                        if(res.isHidden){
