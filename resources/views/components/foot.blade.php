    ...
    <script src="{{asset('admin/assets/libs/autonumeric/autoNumeric.min.js')}}"></script>
    <script src="{{asset('admin/assets/js/pages/form-masks.init.js')}}"></script>
    ...
    {{-- Format currency --}}
    <script src="{{asset('admin/assets/js/simple.money.format.js')}}"></script>
