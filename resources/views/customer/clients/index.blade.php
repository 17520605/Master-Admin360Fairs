                ...
                <div class="card">
                    <div class="header">
                        ...
                        <ul class="header-dropdown">
                            <li><a href="javascript:void(0);" class="btn btn-info" data-toggle="modal" data-target="#add_client">Add New</a></li>
                        </ul>
                    </div>
                    <div class="body">
                                ...
                                <tbody>
                                    @foreach ($users as $user)
                                        <tr>
                                            ...
                                            <td>Tour Admin</td>
                                            <td><span>{{$user->maximumTour}}</span></td>
                                            <td><span>{{$user->profile->contact}}</span></td>
